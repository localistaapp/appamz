    ...
    axios.get(`/stats/${email}`)
      .then(function (response) {
        if(response.data != 'auth error') {
            ...
            if (response.data) {
                window.sessionStorage.setItem('user-profile', '{"user":"'+email+'","storeId":"'+response.data.storeId+'","franchiseId":"'+response.data.franchiseId+'","supportMobile":"'+response.data.supportMobile+'"}');
                /*this.setState({
